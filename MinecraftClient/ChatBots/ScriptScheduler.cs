...
namespace MinecraftClient.ChatBots
{
    ...
    public static Configs Config = new();
        ...
        public class Configs
        {
            ...
            [TomlInlineComment("填写你的账号密码")]

            public const string password = "youpassword";
            ...
            Trigger_On_Interval: new(false,0),
            Action: "send /l password"
           
                ),
            
                new TaskConfig
            (
                Task_Name: "SwitchAndInteractTask",
    Trigger_On_First_Login: false,
    Trigger_On_Login: false,
    Trigger_On_Times: new(false, new TimeSpan[]{TimeSpan.FromSeconds(5), TimeSpan.FromSeconds(10)}),
    Trigger_On_Interval: new(true, 5,10000000000000000000), 
    Action: "changeslot 3"
),

new TaskConfig
(
    Task_Name: "UseItemTask",
    Trigger_On_First_Login: false,
    Trigger_On_Login: false,
    Trigger_On_Times: new(false, Array.Empty<TimeSpan>()),
    Trigger_On_Interval: new(true, 6,10000000000000000000),
    Action: "useitem"
),
        new TaskConfig(
            ...
            Trigger_On_Login: false,
            Trigger_On_Times: new(false, Array.Empty<TimeSpan>()),
            Trigger_On_Interval: new(true, 26,10000000000000000000),
            Action: "script tell.cs"
            )
            ...
            {
                public string Task_Name = "useitem";
                public bool Trigger_On_First_Login = false;
                public bool Trigger_On_Login = false;
                public TriggerOnTimeConfig Trigger_On_Times;
                public TriggerOnIntervalConfig Trigger_On_Interval = new TriggerOnIntervalConfig(false, 1, 10);
                public string Action = "changeslot 3";
                ...
                public TaskConfig()
                {
                    Trigger_On_Times = new TriggerOnTimeConfig(true, new TimeSpan[] { new TimeSpan(0, 0, 4) });
                }
            //
